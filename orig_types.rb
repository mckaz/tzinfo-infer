...
RDL.orig_type Object.const_get('TZInfo::Country'), 'initialize', '(TZInfo::DataSources::CountryInfo) -> self', wrap: false, typecheck: :later
...
RDL.orig_type Object.const_get('TZInfo::DataSource'), 'get_timezone_info', '(String) -> TZInfo::DataSources::TimezoneInfo', wrap: false, typecheck: :later
...
RDL.orig_type Object.const_get('TZInfo::DataSource'), 'get_country_info', '(String) -> TZInfo::DataSources::CountryInfo', wrap: false, typecheck: :later
...
RDL.orig_type Object.const_get('TZInfo::DataSource'), 'load_timezone_info', '(String) -> TZInfo::DataSources::TimezoneInfo', wrap: false, typecheck: :later
RDL.orig_type Object.const_get('TZInfo::DataSource'), 'load_country_info', '(String) -> TZInfo::DataSources::CountryInfo', wrap: false, typecheck: :later
...
RDL.orig_type Object.const_get('TZInfo::DataSource'), 'lookup_country_info', '(String or TZInfo::DataSources::CountryInfo, String, Encoding) -> TZInfo::DataSources::CountryInfo', wrap: false, typecheck: :later
...
RDL.orig_type Object.const_get('TZInfo::InfoTimezone'), 'initialize', '(TZInfo::DataSources::TimezoneInfo) -> self', wrap: false, typecheck: :later
RDL.orig_type Object.const_get('TZInfo::InfoTimezone'), 'identifier', '() -> String', wrap: false, typecheck: :later
RDL.orig_type Object.const_get('TZInfo::InfoTimezone'), 'info', '() -> TZInfo::DataSources::TimezoneInfo', wrap: false, typecheck: :later
...
RDL.orig_type Object.const_get('TZInfo::LinkedTimezone'), 'initialize', '(TZInfo::DataSources::LinkedTimezoneInfo) -> self', wrap: false, typecheck: :later
...
RDL.orig_type Object.const_get('TZInfo::Format1::TimezoneDefinition::ClassMethods'), 'timezone_definer_class', '() -> %bot', wrap: false, typecheck: :later
...
RDL.orig_type Object.const_get('TZInfo::DataSources::RubyDataSource'), 'load_country_info', '(String) -> TZInfo::DataSources::CountryInfo', wrap: false, typecheck: :later
...
RDL.orig_type Object.const_get('TZInfo::Format1::CountryIndexDefinition::ClassMethods'), 'countries', '() -> Hash<String, TZInfo::DataSources::CountryInfo>', wrap: false, typecheck: :later
...
RDL.orig_type Object.const_get('TZInfo::DataSources::ZoneinfoDataSource'), 'load_country_info', '(String) -> TZInfo::DataSources::CountryInfo', wrap: false, typecheck: :later
